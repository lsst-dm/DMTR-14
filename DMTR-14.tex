...
\setDocAbstract{%
This brief report describe measurements of interest that were carried out for release v12.0 of the Science Pipeline.

The report for the previous version can be found in \citeds{DMTR-11}.
}
...
multifit, and data from the 3rd Data Challenge for SDQA \citedsp{Document-26217}.
Calculations
